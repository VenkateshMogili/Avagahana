...
<body><br>
	<center><div class="col-md-12" style="height:600px;overflow:auto;">
		...
		<button class="btn btn-danger" onclick="load_page('ELSD.php')">English Language Application Skills</button>
		...
		$sql=mysqli_query($con,"SELECT * FROM files where f_type='doc' and category='English Language Application Skills' order by id DESC LIMIT 100");

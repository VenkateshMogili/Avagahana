...
<body><br>
	<center><div class="col-md-12" style="height:600px;overflow:auto;">
		...
		<button class="btn btn-danger" onclick="load_page('JLD.php')">Japanese Language</button>
		<button class="btn btn-primary" onclick="load_page('General.php')">General</button>
		<?php
		session_start();
		require_once 'connect.php';
		$sql=mysqli_query($con,"SELECT * FROM files where f_type='doc' and category='Japanese Language' order by id DESC LIMIT 100");

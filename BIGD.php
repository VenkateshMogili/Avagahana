...
<body><br>
	<center><div class="col-md-12" style="height:600px;overflow:auto;">
		...
		<button class="btn btn-danger" onclick="load_page('BIGD.php')">Better Intellectual Growth</button>
		...
		$sql=mysqli_query($con,"SELECT * FROM files where f_type='doc' and category='Better Intellectual Growth' order by id DESC LIMIT 100");

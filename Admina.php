...
<h2 style="color:magenta"><center>Post Audio Notification</center></h2>
<div class="jumbotron">
<center><form action="post_noticea.php" method="post" enctype="multipart/form-data">
	<center><h5 style="color:green">Available formats: .mp3</h5></center>
	...
	<br>
    <b style="color:navy;font-family:arial;">Choose your Audio file:</b>
